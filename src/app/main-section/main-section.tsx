            ...
            <div className="bg-white/30 backdrop-blur-sm duration-300 h-[520px] flex">
                <div className="container grid grid-cols-1 place-content-center">
                    <div className="text-start space-y-5 pl-20">
                        ...
                        <p className="text-md md:text-lg font-normal justify-between w-[300px] md:w-[500px] sm:w-[400px] lg:w-[600px] fade-ups fadeUp">This sentence emphasizes how incorporating songs and melodies can simplify remembering information, whether for students, professionals, or anyone aiming to improve memory. Ideal for educational platforms or apps, it motivates users to adopt enjoyable, efficient learning techniques that boost retention through rhythm and repetition..</p>
                        <button className="my-5 bg-[#a28089] hover:bg-[#aa93d5] hover:text-blue-300 text-red font-bold py-2 px-4 rounded transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg relative overflow-hidden fade-ups fadeUp">
                <Link href={"blogs"}>
